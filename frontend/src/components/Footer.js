  ...
  return (
    <footer className="footer">
      <div className="footer_top">
        <img src="/images/logos-03.svg" alt="footerLogo" />
        <div className="footer_top__inner">
      ...
      <div className="footer_bottom">
        ...
        <div className="footer_bottom__social">
          <div className="footer_bottom__icons">
            <svg
              id="Layer_1"
              data-name="Layer 1"
